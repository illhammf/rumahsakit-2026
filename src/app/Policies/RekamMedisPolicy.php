...
class RekamMedisPolicy
{
    ...
    {
        return $user->can('view_any_rekam::medis');
    }
    ...
    {
        return $user->can('view_rekam::medis');
    }
    ...
    {
        return $user->can('create_rekam::medis');
    }
    ...
    {
        return $user->can('update_rekam::medis');
    }
    ...
    {
        return $user->can('delete_rekam::medis');
    }
    ...
    {
        return $user->can('delete_any_rekam::medis');
    }
     ...
     */
    public function replicate(User $user, RekamMedis $rekamMedis): bool
    {
